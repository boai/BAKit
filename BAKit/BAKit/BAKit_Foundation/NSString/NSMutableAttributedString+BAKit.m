 ...
 */
+ (NSMutableAttributedString *)ba_mutableAttributedStringWithAllString:(NSString *)allString heighLightString:(NSString *)heighLightString heighLightColor:(UIColor *)heighLightColor
{
