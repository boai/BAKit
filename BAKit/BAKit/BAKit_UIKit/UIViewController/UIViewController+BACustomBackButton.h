...
//  源码地址：https://github.com/peanutNote/QYNavBackButton

#import <UIKit/UIKit.h>

@interface BAMaskView : UIView

@property (nonatomic, strong) UIButton *backButton;

@end

@protocol BANavBackButtonDelegate <NSObject>
...
@interface UIViewController (BACustomBackButton) <BANavBackButtonDelegate>
